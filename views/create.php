...
<body>
    ...
    <form class="main" action="index.php?action=createCV" method="POST">
        <h1 id="name">
            <input type="text" id="nameInput" value="Full Name" name="name">
        </h1>
        ...
        <section class="education" id="education">
            <input type="text" id="bio" name="education" value="Enter your education.">
        </section>
        ...
        <section id="skills">
            <h2>Experience</h2>
            <input type='text' id='experience' value="Add Experience" name="experience" />
        </section>n>

        <section id="projects">
            <h2>Projects</h2>
            <h3><input id="project" type="text" name="project"value="Insert project information" name="project"></h3>
