...
<body>
    ...
    <section class="summary" id="summary">
        <input type="image" id="image" src="https://www.exscribe.com/wp-content/uploads/2021/08/placeholder-image-person-jpg.jpg" alt="Photograph of the user" width = "150" height="150">
	...
	<h2>Experience</h2>
	<h3><input id="exp" type="text" value="Work experience"></h3>
